...
import rfitirfpresponsemanagement from "./../data/rfitorfpresponsemanagement.json";

const RfiToRfpResponseManagement = () => {
              ...
              <div className=" inline-block min-w-full py-2 align-middle ">
                <table className="min-w-full">
                  ...
                  <tbody className="bg-white">
                    {rfitirfpresponsemanagement.map((row) => (
...
export default RfiToRfpResponseManagement;
